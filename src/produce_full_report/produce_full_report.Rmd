...
week_starting <- as.Date('19-07-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 19^th^ July 2020,  more than
14,000,000 cases of COVID-19 have been reported across the world, with more than 597,000
deaths [@whositrep]. 
...
ascertainment) for 58 countries with active transmission.
...
two weeks. For the week beginning 19^th^ July 2020, 
...
transmission for the week ending 19^th^ July 2020. A country is defined
...
*Figure 14.* Projections (7-day ahead) for the week starting 19^th^ July 2020 from individual models
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 19^th^ July 2020 from individual models (Models 1, 2
...
*Figure 16.* Projections (7-day ahead) for the week starting 19^th^ July 2020 from individual models (Models 1, 2
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 19^th^ July 2020 from individual models (Models 1, 2
...
19^th^ July 2020 from individual models (Models 1, 2
