...
As of 7^th^ December 2020,  more than
65,000,000 cases of COVID-19 have been reported across the world, 
with more than 1,520,000 deaths [@whositrep]. 
...
ascertainment) for 82 countries with active transmission.
...
two weeks. For the week beginning 7^th^ December 2020, 
the number of countries/regions included based on these thresholds is 82.
...
transmission for the week ending 7^th^ December 2020. A country is defined
...
7^th^ December 2020, the observed number of deaths in the week before,
...
```{r echo = FALSE, warning = FALSE, message = FALSE}
knitr::include_graphics("figs/reporting_ratio_Europe_page_5.png")
```


```{r echo = FALSE, warning = FALSE, message = FALSE}
knitr::include_graphics("figs/reporting_ratio_Europe_page_6.png")

knitr::include_graphics("figs/reporting_ratio_Europe_page_7.png")
```
...
```{r echo = FALSE, warning = FALSE, message = FALSE}
knitr::include_graphics("figs/reporting_ratio_Asia_page_4.png")
```
...
*Figure 14.* Projections (7-day ahead) for the week starting 7^th^ December 2020 from individual models
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 7^th^ December 2020 from individual models (Models 1, 2
...
```
*Figure 16.* Projections (7-day ahead) for the week starting 7^th^ December 2020 from individual models (Models 1, 2
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 7^th^ December 2020 from individual models (Models 1, 2
...
7^th^ December 2020 from individual models (Models 1, 2
