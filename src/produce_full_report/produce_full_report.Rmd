...
As of 10^th^ May 2021,  more than
157,000,000 cases of COVID-19 have been reported across the world, 
with more than 3,280,000 deaths [@whositrep]. 

This weekly report presents forecasts of the
*reported* number of deaths in the week ahead 
for 73 countries with active transmission. We also present similar results for
...
two weeks. For the week starting 10^th^ May 2021, 
the number of countries/regions included based on these thresholds is 73.
...
10^th^ May 2021, the observed number of deaths in the week before,
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 10^th^ May 2021 from individual models
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 10^th^ May 2021 from individual models (Models 1, 2
...
```
*Figure 18.* Projections (7-day ahead) for the week starting 10^th^ May 2021 from individual models (Models 1, 2
...
10^th^ May 2021 from individual models (Models 1, 2
