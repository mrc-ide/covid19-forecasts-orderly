...
As of 6^th^ September 2021, more than
220,000,000 cases of COVID-19 have been reported across the world, 
with more than 4,560,000 deaths [@whositrep]. 
...
two weeks. For the week starting 6^th^ September 2021, 
...
6^th^ September 2021, the observed number of deaths in the week before,
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 6^th^ September 2021 from individual models
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 6^th^ September 2021 from individual models (Models 1, 2
...
```
*Figure 18.* Projections (7-day ahead) for the week starting 6^th^ September 2021 from individual models (Models 1, 2
...
6^th^ September 2021 from individual models (Models 1, 2
