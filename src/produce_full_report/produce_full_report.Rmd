...
week_starting <- as.Date('19-04-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 19-04-2020,  more than
2,200,000 cases of COVID-19 have been reported across the world, with more than 150,000
...
ascertainment) for 45 countries with active transmission.
...
two weeks. For the week beginning 19-04-2020,
the number of countries/regions included based on these thresholds is 45.
...
Sunday). Projections for countries marked with
...
case_at <- readr::read_csv(
    "unformatted_summary_DeathToRepoted_14days_2020-04-19.csv"
)
...
x <- readr::read_csv("summary_DeathToRepoted_14days_2020-04-19.csv")
x <- dplyr::select(
...
```
*Figure 12.* Projections (7-day ahead) for the week starting 19-04-2020 from individual models
...
```
*Figure 13.* Projections (7-day ahead) for the week starting 19-04-2020 from individual models (Models 1, 2
...
*Figure 14.* Projections (7-day ahead) for the week starting 19-04-2020 from individual models (Models 1, 2
...
*Figure 15.* Projections (7-day ahead) for the week starting 19-04-2020 from individual models (Models 1, 2
...
*Figure 16.* Projections (7-day ahead) for the week starting 19-04-2020 from individual models (Models 1, 2
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-19_Europe.png")
```
...
19-04-2020. For countries marked with a **, $R_t$ estimates from three
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-19_Asia.png")
```

*Figure 18.* Estimates of $R_t$ from individual models for each country in Asia with
active transmission (see Methods) for the week starting
19-04-2020. For countries marked with a *, $R_t$ estimates from two
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-19_Africa.png")
```
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-19_North America.png")
```
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-19_South America.png")
```
...
Sangeeta Bhatia, Anne Cori, Kris V Parag, Swapnil Mishra,
