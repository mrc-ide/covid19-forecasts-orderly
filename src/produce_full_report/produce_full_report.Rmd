...
week_starting <- as.Date('03-05-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 03-05-2020,  more than
3,300,000 cases of COVID-19 have been reported across the world, with more than 230,000
...
ascertainment) for 51 countries with active transmission.
...
```
*Figure 1.* Estimates of transmissibility in countries with active
transmission for the week ending 03-05-2020. 
Based on our best estimates of transmissibility, the
COVID-19 epidemic is likely declining in 4 countries (shown in green), 
likely stabilising or growing slowly in 23 countries (shown in pale
green), and likely growing in 9 countries (shown in dark orange). The
trend is unclear in 12 countries (shown in pale orange). Note that
...
two weeks. For the week beginning 03-05-2020,
the number of countries/regions included based on these thresholds is 51.
...
and 3). For countries marked with ** (Austria, Belgium, Denmark, France, Germany, Greece, 
Italy, Netherlands, Norway, Portugal, Spain, Sweden, 
Switzerland, and United Kingdom), projections are based on an ensemble
that includes 4 models (Models 1,
2, 3 and 4). Results from individual models are shown
...
Model 3 does not estimate $R_t$). For countries marked with **
(Austria, Belgium, Denmark, France, Germany, Greece, 
Italy, Netherlands, Norway, Portugal, Spain, Sweden, 
Switzerland, and United Kingdom), estimates of
...
```
*Figure 12.*: Temporal trends in the ratio of reported
...
case_at <- readr::read_csv(
    "unformatted_summary_DeathToRepoted_14days_2020-05-03.csv"
)
...
x <- readr::read_csv("summary_DeathToRepoted_14days_2020-05-03.csv")
x <- dplyr::select(
...
```
*Figure 13.* Projections (7-day ahead) for the week starting 03-05-2020 from individual models
...
```
*Figure 14.* Projections (7-day ahead) for the week starting 03-05-2020 from individual models (Models 1, 2
...
*Figure 15.* Projections (7-day ahead) for the week starting 03-05-2020 from individual models (Models 1, 2
...
*Figure 16.* Projections (7-day ahead) for the week starting 03-05-2020 from individual models (Models 1, 2
...
*Figure 17.* Projections (7-day ahead) for the week starting 03-05-2020 from individual models (Models 1, 2
...
03-05-2020. For countries marked with a **, $R_t$ estimates from three
...
active transmission (see Methods) for the week starting
03-05-2020. For countries marked with a *, $R_t$ estimates from two
...
```
*Figure 22.* Estimates of $R_t$ from individual models for each country in Africa with
active transmission (see Methods) for the week starting
03-05-2020. For countries marked with a *, $R_t$ estimates from two
models are available (Models 1 and 2). 
...
*Note* For the week beginning 03-05-2020, the following edits were
made to the data downloaded from ECDC: 
- For Germany, 287 deaths were reported on 02-05-2020 by ECDC while
the number of deaths on 01-5-2020 was 0. We changed this to 156 deaths
on 01-05-2020 and 113 deaths on 02-05-2020.
- The number of deaths reported for Ireland for 03-05-2020 was 0. This
  was changed to 21 deaths.
- For Spain, 0 deaths were reported for 27-04-2020, and 632 deaths
were reported on 28-04-2020. We edited this to 331 deaths on
27-04-2020 and 301 deaths on 28-04-2020. Similarly, there was no
record for Spain for 02-05-2020 and 276 deaths recorded on
03-05-2020. This was changed to 276 deaths on 02-05-2020 and 164
deaths on 03-05-2020.

For all these edits, the numbers reported on Worldometers
(https://www.worldometers.info/coronavirus/) were used.
