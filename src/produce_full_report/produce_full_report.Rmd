...
week_starting <- as.Date('02-08-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 2^nd^ August 2020,  more than
17,000,000 cases of COVID-19 have been reported across the world, 
with more than 680,000 deaths [@whositrep]. 
...
ascertainment) for 65 countries with active transmission.
...
two weeks. For the week beginning 2^nd^ August 2020, 
...
transmission for the week ending 2^nd^ August 2020. A country is defined
...
*Figure 15.* Projections (7-day ahead) for the week starting 2^nd^ August 2020 from individual models
...
```
*Figure 16.* Projections (7-day ahead) for the week starting 2^nd^ August 2020 from individual models (Models 1, 2
...
*Figure 17.* Projections (7-day ahead) for the week starting 2^nd^ August 2020 from individual models (Models 1, 2
...
```
*Figure 18.* Projections (7-day ahead) for the week starting 2^nd^ August 2020 from individual models (Models 1, 2
...
2^nd^ August 2020 from individual models (Models 1, 2
...
[here](https://github.com/mrc-ide/covid19-forecasts-orderly/blob/main/src/prepare_ecdc_data/R/corrections_02August.R). 
