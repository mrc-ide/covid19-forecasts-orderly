...
As of 14^th^ September 2020,  more than
28,000,000 cases of COVID-19 have been reported across the world, 
with more than 921,000 deaths [@whositrep]. 
...
two weeks. For the week beginning 14^th^ September 2020, 
...
transmission for the week ending 14^th^ September 2020. A country is defined
...
14^th^ September, the observed number of deaths in the week before,
...
*Figure 15.* Projections (7-day ahead) for the week starting 14^th^ September 2020 from individual models
...
```
*Figure 16.* Projections (7-day ahead) for the week starting 14^th^ September 2020 from individual models (Models 1, 2
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 14^th^ September 2020 from individual models (Models 1, 2
...
```
*Figure 18.* Projections (7-day ahead) for the week starting 14^th^ September 2020 from individual models (Models 1, 2
...
14^th^ September 2020 from individual models (Models 1, 2
...
[here](https://github.com/mrc-ide/covid19-forecasts-orderly/blob/main/src/prepare_ecdc_data/R/corrections_14Sept.R). 
