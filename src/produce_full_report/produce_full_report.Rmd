...
zip::unzip('us-figs.zip', overwrite = TRUE)
...
As of `r week_in_words` 2021, more than
269,000,000 cases of COVID-19 have been reported across the world, 
with more than 5,300,000 deaths [@whositrep]. 
...
two weeks. For the week starting `r week_in_words` 2021, 
...
```{r echo = FALSE, warning = FALSE, message = FALSE}
knitr::include_graphics("figures/us_ensemble_forecasts_1.png")
knitr::include_graphics("figures/us_ensemble_forecasts_2.png")
##knitr::include_graphics("figures/us_ensemble_forecasts_3.png")
##knitr::include_graphics("figures/us_ensemble_forecasts_4.png")

```
*Figure 8.* Reported daily deaths and current forecasts based on the ensemble
...
```
*Figure 9.* Latest estimates of transmissibility in countries with active
...
```
*Figure 15.*: Latest estimates of effective reproduction numbers by country
...
```{r echo = FALSE, warning = FALSE, message = FALSE}
knitr::include_graphics("figures/us_ensemble_rt_box_1.png")
```
*Figure 16.*: Latest estimates of effective reproduction numbers 
...
`r week_in_words` 2021, the observed number of deaths in the week before,
...
```
*Figure 17.* Projections (7-day ahead) for the week starting `r week_in_words` 2021 from individual models
...
```
*Figure 18.* Projections (7-day ahead) for the week starting 31^st^
...
```
*Figure 19.* Projections (7-day ahead) for the week starting `r week_in_words` 2021 from individual models (Models 1, 2
...
```
*Figure 20.* Projections (7-day ahead) for the week starting `r week_in_words` 2021 from individual models (Models 1, 2
...
```
*Figure 21.* Projections (7-day ahead) for the week starting `r week_in_words` 2021 from individual models (Models 1, 2
...
*Figure 22.* Projections (7-day ahead) for the week starting
`r week_in_words` 2021 from individual models (Models 1, 2
...
```{r}
knitr::include_graphics("figures/us_indvdl_forecasts_1.png")
knitr::include_graphics("figures/us_indvdl_forecasts_2.png")
##knitr::include_graphics("figures/us_indvdl_forecasts_3.png")
##knitr::include_graphics("figures/us_indvdl_forecasts_4.png")


```
*Figure 23.* Projections (7-day ahead) for the week starting
`r week_in_words` 2021 from individual models (Models 1, 2
...
```
*Figure 24.* Estimates of $R_t$ from individual models for each country in Europe with
active transmission (see Methods) for the week starting
`r week_in_words` 2021. 
...
*Figure 25.* Estimates of $R_t$ from individual models for each country in Asia with
active transmission (see Methods) for the week starting
`r week_in_words` 2021. 
...
*Figure 26.* Estimates of $R_t$ from individual models for each country in Africa with
active transmission (see Methods) for the week starting
`r week_in_words` 2021. 
...
```
*Figure 27.* Estimates of $R_t$ from individual models for each country in
...
```
*Figure 28.* Estimates of $R_t$ from individual models for each country in
Oceania with
active transmission (see Methods) for the week starting
`r week_in_words` 2021. 
...
```
*Figure 29.* Estimates of $R_t$ from individual models for each
...
```{r}
knitr::include_graphics("figures/us_indvdl_rt_line_1.png")
```
*Figure 30.* Estimates of $R_t$ from individual models for each
...
Sangeeta Bhatia, Jack Wardle, Rebecca Nash, Anne Cori, Kris V Parag, Swapnil Mishra, Laura V Cooper,
