...
As of 31^st^ January 2021,  more than
102,000,000 cases of COVID-19 have been reported across the world, 
with more than 2,200,000 deaths [@whositrep]. 
...
ascertainment) for 74 countries with active transmission.
...
two weeks. For the week starting 31^st^ January 2021, 
the number of countries/regions included based on these thresholds is 74.
...
knitr::include_graphics("figs/ensmbl_pred_Africa_si_2_page_5.png")
```
...
31^st^ January 2021, the observed number of deaths in the week before,
...
```
*Figure 13.* Projections (7-day ahead) for the week starting 31^st^ January 2021 from individual models
...
knitr::include_graphics("figs/Africa_si_2_page_5.png")

```
*Figure 15.* Projections (7-day ahead) for the week starting 31^st^ January 2021 from individual models (Models 1, 2
...
```
*Figure 16.* Projections (7-day ahead) for the week starting 31^st^ January 2021 from individual models (Models 1, 2
...
31^st^ January 2021 from individual models (Models 1, 2
