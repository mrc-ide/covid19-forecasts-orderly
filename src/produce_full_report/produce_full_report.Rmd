...
```
*Figure 15.* Projections (7-day ahead) for the week starting `r week_in_words` 2021 from individual models
...
```
*Figure 17.* Projections (7-day ahead) for the week starting `r week_in_words` 2021 from individual models (Models 1, 2
...
```
*Figure 18.* Projections (7-day ahead) for the week starting `r week_in_words` 2021 from individual models (Models 1, 2
