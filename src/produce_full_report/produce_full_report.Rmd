...
As of 17^th^ May 2021,  more than
162,000,000 cases of COVID-19 have been reported across the world, 
with more than 3,360,000 deaths [@whositrep]. 

This weekly report presents forecasts of the
*reported* number of deaths in the week ahead 
for 72 countries with active transmission. We also present similar results for
...
two weeks. For the week starting 17^th^ May 2021, 
...
knitr::include_graphics("us-figs/us_ensemble_forecasts_4.png")
knitr::include_graphics("us-figs/us_ensemble_forecasts_5.png")
knitr::include_graphics("us-figs/us_ensemble_forecasts_6.png")
knitr::include_graphics("us-figs/us_ensemble_forecasts_7.png")
knitr::include_graphics("us-figs/us_ensemble_forecasts_8.png")
knitr::include_graphics("us-figs/us_ensemble_forecasts_9.png")
knitr::include_graphics("us-figs/us_ensemble_forecasts_10.png")
knitr::include_graphics("us-figs/us_ensemble_forecasts_11.png")
knitr::include_graphics("us-figs/us_ensemble_forecasts_12.png")
knitr::include_graphics("us-figs/us_ensemble_forecasts_13.png")
##knitr::include_graphics("us-figs/us_ensemble_forecasts_14.png")
...
```{r echo = FALSE, warning = FALSE, message = FALSE}
knitr::include_graphics("us-figs/us_ensemble_rt_box_2.png")
...
17^th^ May 2021, the observed number of deaths in the week before,
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 17^th^ May 2021 from individual models
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 17^th^ May 2021 from individual models (Models 1, 2
...
```
*Figure 18.* Projections (7-day ahead) for the week starting 17^th^ May 2021 from individual models (Models 1, 2
...
17^th^ May 2021 from individual models (Models 1, 2
...
knitr::include_graphics("us-figs/us_indvdl_forecasts_4.png")
knitr::include_graphics("us-figs/us_indvdl_forecasts_5.png")
knitr::include_graphics("us-figs/us_indvdl_forecasts_6.png")
knitr::include_graphics("us-figs/us_indvdl_forecasts_7.png")
knitr::include_graphics("us-figs/us_indvdl_forecasts_8.png")
knitr::include_graphics("us-figs/us_indvdl_forecasts_9.png")
knitr::include_graphics("us-figs/us_indvdl_forecasts_10.png")
knitr::include_graphics("us-figs/us_indvdl_forecasts_11.png")
knitr::include_graphics("us-figs/us_indvdl_forecasts_12.png")
knitr::include_graphics("us-figs/us_indvdl_forecasts_13.png")
##knitr::include_graphics("us-figs/us_indvdl_forecasts_14.png")
...
```{r}
knitr::include_graphics("us-figs/us_indvdl_rt_line_2.png")
