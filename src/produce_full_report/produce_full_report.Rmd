...
As of 5^th^ July 2021,  more than
183,000,000 cases of COVID-19 have been reported across the world, 
with more than 3,970,000 deaths [@whositrep]. 
...
two weeks. For the week starting 5^th^ July 2021, 
...
5^th^ July 2021, the observed number of deaths in the week before,
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 5^th^ July 2021 from individual models
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 5^th^ July 2021 from individual models (Models 1, 2
...
```
*Figure 18.* Projections (7-day ahead) for the week starting 5^th^ July 2021 from individual models (Models 1, 2
...
5^th^ July 2021 from individual models (Models 1, 2
