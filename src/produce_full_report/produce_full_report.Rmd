...
519,100,000 cases of COVID-19 (including potential re-infections) have been reported across the world, 
with more than 6,266,000 deaths [@whositrep]. 
...
serial interval with mean 3.3 days
and standard deviation of 3.5 days following [@abbott2022].
...
```
*Figure 13.* Projections (7-day ahead) for the week starting 
...
```
*Figure 14.* Projections (7-day ahead) for the week starting  `r week_in_words`
...
```
*Figure 15.* Projections (7-day ahead) for the week starting `r week_in_words` from individual models (Models 1, 2
...
```
*Figure 16.* Projections (7-day ahead) for the week starting `r week_in_words` from individual models (Models 1, 2
