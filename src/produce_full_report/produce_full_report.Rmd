...
week_starting <- as.Date('10-05-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 10-05-2020,  more than
3,900,000 cases of COVID-19 have been reported across the world, with more than 270,000
...
ascertainment) for 54 countries with active transmission.
...
transmission for the week ending 10-05-2020. 
...
two weeks. For the week beginning 10-05-2020,
the number of countries/regions included based on these thresholds is 54.
...
case_at <- readr::read_csv(
    "unformatted_summary_DeathToRepoted_14days_2020-05-10.csv"
)
...
x <- readr::read_csv("summary_DeathToRepoted_14days_2020-05-10.csv")
x <- dplyr::select(
...
```
*Figure 13.* Projections (7-day ahead) for the week starting 10-05-2020 from individual models
...
```
*Figure 14.* Projections (7-day ahead) for the week starting 10-05-2020 from individual models (Models 1, 2
...
*Figure 15.* Projections (7-day ahead) for the week starting 10-05-2020 from individual models (Models 1, 2
...
*Figure 16.* Projections (7-day ahead) for the week starting 10-05-2020 from individual models (Models 1, 2
...
10-05-2020 from individual models (Models 1, 2
...
10-05-2020. For countries marked with a *, $R_t$ estimates from two
...
ECDC did not contain data for 10-05-2020 for Spain. 1880 cases and 143
deaths were manually added to the downloaded file using the numbers
reported on Worldometers (https://www.worldometers.info/coronavirus/).

- Cameroon and Ecuador were excluded from the analysis because of 
concerns about reporting of deaths and cases.
