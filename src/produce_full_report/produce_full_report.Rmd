...
week_starting <- as.Date('26-07-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 26^th^ July 2020,  more than
15,000,000 cases of COVID-19 have been reported across the world, with more than 640,000
deaths [@whositrep]. 
...
two weeks. For the week beginning 26^th^ July 2020, 
...
transmission for the week ending 26^th^ July 2020. A country is defined
...
*Figure 15.* Projections (7-day ahead) for the week starting 26^th^ July 2020 from individual models
...
```
*Figure 16.* Projections (7-day ahead) for the week starting 26^th^ July 2020 from individual models (Models 1, 2
...
*Figure 17.* Projections (7-day ahead) for the week starting 26^th^ July 2020 from individual models (Models 1, 2
...
```
*Figure 18.* Projections (7-day ahead) for the week starting 26^th^ July 2020 from individual models (Models 1, 2
...
26^th^ July 2020 from individual models (Models 1, 2
...
[here](https://github.com/mrc-ide/covid19-forecasts-orderly/blob/main/src/prepare_ecdc_data/R/corrections_26July.R). 
