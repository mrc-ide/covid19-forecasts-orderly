...
week_starting <- as.Date('12-07-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 12^th^ July 2020,  more than
12,500,000 cases of COVID-19 have been reported across the world, with more than 561,000
deaths [@whositrep]. 
...
ascertainment) for 56 countries with active transmission.
...
two weeks. For the week beginning 12^th^ July 2020, 
the number of countries/regions included based on these thresholds is 56.
...
transmission for the week ending 12^th^ July 2020. A country is defined
...
*Figure 14.* Projections (7-day ahead) for the week starting 12^th^ July 2020 from individual models
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 12^th^ July 2020 from individual models (Models 1, 2
...
*Figure 16.* Projections (7-day ahead) for the week starting 12^th^ July 2020 from individual models (Models 1, 2
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 12^th^ July 2020 from individual models (Models 1, 2
...
12^th^ July 2020 from individual models (Models 1, 2
...
[here](https://github.com/mrc-ide/covid19-forecasts-orderly/blob/main/src/prepare_ecdc_data/R/corrections_12July.R). 
All corrections are based on the numbers reported by the World Health Organization (https://covid19.who.int).
