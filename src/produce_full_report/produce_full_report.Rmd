...
week_starting <- as.Date('26-04-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 26-04-2020,  more than
2,800,000 cases of COVID-19 have been reported across the world, with more than 190,000
...
two weeks. For the week beginning 26-04-2020,
...
case_at <- readr::read_csv(
    "unformatted_summary_DeathToRepoted_14days_2020-04-26.csv"
)
...
x <- readr::read_csv("summary_DeathToRepoted_14days_2020-04-26.csv")
x <- dplyr::select(
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-26_Europe.png")
```
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-26_Asia.png")
```
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-26_Africa.png")
```
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-26_North America.png")
```
...
```{r}
knitr::include_graphics("figs/rt_si_2_2020-04-26_South America.png")
```
