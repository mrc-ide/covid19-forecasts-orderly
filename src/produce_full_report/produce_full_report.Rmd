...
As of 25^th^ January 2021,  more than
97,000,000 cases of COVID-19 have been reported across the world, 
with more than 2,120,000 deaths [@whositrep]. 
...
ascertainment) for 72 countries with active transmission.
...
two weeks. For the week starting 25^th^ January 2021, 
the number of countries/regions included based on these thresholds is 72.
...
25^th^ January 2021, the observed number of deaths in the week before,
...
```
*Figure 13.* Projections (7-day ahead) for the week starting 25^th^ January 2021 from individual models
...
```
*Figure 14.* Projections (7-day ahead) for the week starting 25^th^
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 25^th^ January 2021 from individual models (Models 1, 2
...
```
*Figure 16.* Projections (7-day ahead) for the week starting 25^th^ January 2021 from individual models (Models 1, 2
...
25^th^ January 2021 from individual models (Models 1, 2
