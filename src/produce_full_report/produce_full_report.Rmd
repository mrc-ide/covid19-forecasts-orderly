...
week_starting <- as.Date('28-06-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 28^th^ June 2020,  more than
9,800,000 cases of COVID-19 have been reported across the world, with more than 495,000
deaths [@whositrep]. 
...
ascertainment) for 55 countries with active transmission.
...
two weeks. For the week beginning 28^th^ June 2020, 
the number of countries/regions included based on these thresholds is 55.
...
transmission for the week ending 28^th^ June 2020. A country is defined
...
*Figure 14.* Projections (7-day ahead) for the week starting 28^th^ June 2020 from individual models
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 28^th^ June 2020 from individual models (Models 1, 2
...
*Figure 16.* Projections (7-day ahead) for the week starting 28^th^ June 2020 from individual models (Models 1, 2
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 28^th^ June 2020 from individual models (Models 1, 2
...
28^th^ June 2020 from individual models (Models 1, 2
...
reliable inference. 
A complete list of corrections applied to the data downloaded
from ECDC is
available
[here](https://github.com/mrc-ide/covid19-forecasts-orderly/blob/main/src/prepare_ecdc_data/R/corrections_28June.R). 
All corrections are based on the numbers
