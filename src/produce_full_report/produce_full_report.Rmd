...
As of 12^th^ April 2021,  more than
135,000,000 cases of COVID-19 have been reported across the world, 
with more than 2,920,000 deaths [@whositrep]. 
...
ascertainment) for 67 countries with active transmission. We also
present results for states and territories with ongoing transmission 
...
two weeks. For the week starting 12^th^ April 2021, 
the number of countries/regions included based on these thresholds is 67.
...
knitr::include_graphics("figs/ensmbl_pred_Europe_si_2_page_6.png")
knitr::include_graphics("figs/ensmbl_pred_Europe_si_2_page_7.png")
knitr::include_graphics("figs/ensmbl_pred_Europe_si_2_page_8.png")
knitr::include_graphics("figs/ensmbl_pred_Europe_si_2_page_9.png")
knitr::include_graphics("figs/ensmbl_pred_Europe_si_2_page_10.png")
...
knitr::include_graphics("figs/ensmbl_pred_Asia_si_2_page_4.png")
knitr::include_graphics("figs/ensmbl_pred_Asia_si_2_page_5.png")
##knitr::include_graphics("figs/ensmbl_pred_Asia_si_2_page_6.png")
...
knitr::include_graphics("figs/ensmbl_pred_Africa_si_2_page_3.png")
##knitr::include_graphics("figs/ensmbl_pred_Africa_si_2_page_4.png")
...
knitr::include_graphics("figs/ensmbl_pred_North America_si_2_page_3.png")
...
knitr::include_graphics("figs/ensmbl_pred_South America_si_2_page_3.png")
```
...
a * are based on an unweighted ensemble of three models (Models 1, 2
and 3, see Methods). The reporting of deaths and cases in Brazil is
currently changing; results should be interpreted with caution.


### USA (sub-national)

```{r echo = FALSE, warning = FALSE, message = FALSE}
knitr::include_graphics("figs/us_ensemble_forecasts_1.png")
knitr::include_graphics("figs/us_ensemble_forecasts_2.png")
knitr::include_graphics("figs/us_ensemble_forecasts_3.png")
knitr::include_graphics("figs/us_ensemble_forecasts_4.png")
knitr::include_graphics("figs/us_ensemble_forecasts_5.png")
knitr::include_graphics("figs/us_ensemble_forecasts_6.png")
knitr::include_graphics("figs/us_ensemble_forecasts_7.png")
knitr::include_graphics("figs/us_ensemble_forecasts_8.png")
knitr::include_graphics("figs/us_ensemble_forecasts_9.png")
knitr::include_graphics("figs/us_ensemble_forecasts_10.png")
knitr::include_graphics("figs/us_ensemble_forecasts_11.png")
knitr::include_graphics("figs/us_ensemble_forecasts_12.png")
knitr::include_graphics("figs/us_ensemble_forecasts_13.png")
knitr::include_graphics("figs/us_ensemble_forecasts_14.png")
knitr::include_graphics("figs/us_ensemble_forecasts_15.png")
...
```
*Figure 7.* Latest estimates of transmissibility in countries with active
...
knitr::include_graphics("figs/us_ensemble_rt_box_1.png")
knitr::include_graphics("figs/us_ensemble_rt_box_2.png")

```
## Summary of results

**Table 1.** Forecasted weekly death counts for week starting 
12^th^ April 2021, the observed number of deaths in the week before,
...
```
```{r}
knitr::include_graphics("figs/Europe_si_2_page_6.png")
```

```{r}
knitr::include_graphics("figs/Europe_si_2_page_7.png")
```

```{r}
knitr::include_graphics("figs/Europe_si_2_page_8.png")
```

```{r}
knitr::include_graphics("figs/Europe_si_2_page_9.png")
```

```{r}
knitr::include_graphics("figs/Europe_si_2_page_10.png")
```
*Figure 13.* Projections (7-day ahead) for the week starting 12^th^ April 2021 from individual models
...
```
```{r}
knitr::include_graphics("figs/Asia_si_2_page_4.png")
```

```{r}
knitr::include_graphics("figs/Asia_si_2_page_5.png")
##knitr::include_graphics("figs/Asia_si_2_page_6.png")
```
*Figure 14.* Projections (7-day ahead) for the week starting 31^st^
...
knitr::include_graphics("figs/Africa_si_2_page_3.png")
##knitr::include_graphics("figs/Africa_si_2_page_4.png")
```
*Figure 15.* Projections (7-day ahead) for the week starting 12^th^ April 2021 from individual models (Models 1, 2
...
knitr::include_graphics("figs/North America_si_2_page_3.png")
```
*Figure 16.* Projections (7-day ahead) for the week starting 12^th^ April 2021 from individual models (Models 1, 2
...
knitr::include_graphics("figs/South America_si_2_page_3.png")
```
*Figure 17.* Projections (7-day ahead) for the week starting
12^th^ April 2021 from individual models (Models 1, 2
...
```{r}
knitr::include_graphics("figs/us_indvdl_forecasts_1.png")
knitr::include_graphics("figs/us_indvdl_forecasts_2.png")
knitr::include_graphics("figs/us_indvdl_forecasts_3.png")
knitr::include_graphics("figs/us_indvdl_forecasts_4.png")
knitr::include_graphics("figs/us_indvdl_forecasts_5.png")
knitr::include_graphics("figs/us_indvdl_forecasts_6.png")
knitr::include_graphics("figs/us_indvdl_forecasts_7.png")
knitr::include_graphics("figs/us_indvdl_forecasts_8.png")
knitr::include_graphics("figs/us_indvdl_forecasts_9.png")
knitr::include_graphics("figs/us_indvdl_forecasts_10.png")
knitr::include_graphics("figs/us_indvdl_forecasts_11.png")
knitr::include_graphics("figs/us_indvdl_forecasts_12.png")
knitr::include_graphics("figs/us_indvdl_forecasts_13.png")
knitr::include_graphics("figs/us_indvdl_forecasts_14.png")
knitr::include_graphics("figs/us_indvdl_forecasts_15.png")
...
```
*Figure 18.* Estimates of $R_t$ from individual models for each country in Europe with
...
*Figure 19.* Estimates of $R_t$ from individual models for each country in Asia with
active transmission (see Methods) for the week starting
12^th^ April 2021. 
...
*Figure 20.* Estimates of $R_t$ from individual models for each country in Africa with
active transmission (see Methods) for the week starting
12^th^ April 2021. 
...
```
*Figure 21.* Estimates of $R_t$ from individual models for each country in
...
```
*Figure 22.* Estimates of $R_t$ from individual models for each
...
```{r}
knitr::include_graphics("figs/us_indvdl_rt_line_1.png")
knitr::include_graphics("figs/us_indvdl_rt_line_2.png")
```
...
Code for the sub-national analysis for the USA is available at
https://github.com/mrc-ide/us-covid19-forecasts-orderly
