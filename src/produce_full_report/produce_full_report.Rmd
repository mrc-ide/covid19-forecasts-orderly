...
As of 14^th^ June 2020,  more than
7,600,000 cases of COVID-19 have been reported across the world, with more than 427,000
...
two weeks. For the week beginning 14^th^ June 2020, 
...
x <- readr::read_csv("summary_DeathToRepoted_14days_2020-06-14.csv")
...
*Figure 12.* Projections (7-day ahead) for the week starting 14^th^ June 2020 from individual models
...
```
*Figure 13.* Projections (7-day ahead) for the week starting 14^th^ June 2020 from individual models (Models 1, 2
...
*Figure 14.* Projections (7-day ahead) for the week starting 14^th^ June 2020 from individual models (Models 1, 2
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 14^th^ June 2020 from individual models (Models 1, 2
...
14^th^ June 2020 from individual models (Models 1, 2
...
*Notes* 
Ecuador, Cameroon, Guatemala, Honduras, Mali, Panama, and Sudan 
...
- The number of deaths in Colombia was manually corrected to 55 on
  12^th^ June and 57 on 13^th^ June.
