...
As of 18^th^ January 2021,  more than
93,000,000 cases of COVID-19 have been reported across the world, 
with more than 2,000,000 deaths [@whositrep]. 
...
ascertainment) for 70 countries with active transmission.
...
two weeks. For the week starting 18^th^ January 2021, 
...
18^th^ January 2021, the observed number of deaths in the week before,
...
```
*Figure 13.* Projections (7-day ahead) for the week starting 18^th^ January 2021 from individual models
...
```
*Figure 14.* Projections (7-day ahead) for the week starting 18^th^
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 18^th^ January 2021 from individual models (Models 1, 2
...
```
*Figure 16.* Projections (7-day ahead) for the week starting 18^th^ January 2021 from individual models (Models 1, 2
...
18^th^ January 2021 from individual models (Models 1, 2
