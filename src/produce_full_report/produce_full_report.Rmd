...
As of 12^th^ October 2020,  more than
37,000,000 cases of COVID-19 have been reported across the world, 
with more than 1,070,000 deaths [@whositrep]. 
...
two weeks. For the week beginning 12^th^ October 2020, 
...
transmission for the week ending 12^th^ October 2020. A country is defined
...
for each country (mean and 95% CI) during the last *14 days*; (**ii**) the estimated
  ...
  deaths. Note that when the ratio of deaths to reported cases is
  greater than the CFR, the case ascertainment ratio is set to 1, CrI
  (1 - 1). See Methods for details.
...
*Figure 14.* Projections (7-day ahead) for the week starting 12^th^ October 2020 from individual models
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 12^th^ October 2020 from individual models (Models 1, 2
...
knitr::include_graphics("figs/Africa_si_2_page_1.png")
```
*Figure 16.* Projections (7-day ahead) for the week starting 12^th^ October 2020 from individual models (Models 1, 2
...
```
*Figure 17.* Projections (7-day ahead) for the week starting 12^th^ October 2020 from individual models (Models 1, 2
...
12^th^ October 2020 from individual models (Models 1, 2
