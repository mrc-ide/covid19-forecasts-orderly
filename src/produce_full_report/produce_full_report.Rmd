...
week_starting <- as.Date('07-06-2020', format = '%d-%m-%Y')

```

# Introduction 

As of 07^th^ June 2020,  more than
6,700,000 cases of COVID-19 have been reported across the world, with more than 397,000
...
ascertainment) for 48 countries with active transmission.
...
two weeks. For the week beginning 7^th^ June 2020, 
the number of countries/regions included based on these thresholds is 48.
...
x <- readr::read_csv("summary_DeathToRepoted_14days_2020-06-07.csv")
...
*Figure 12.* Projections (7-day ahead) for the week starting 7^th^ June 2020 from individual models
...
```
*Figure 13.* Projections (7-day ahead) for the week starting 7^th^ June 2020 from individual models (Models 1, 2
...
*Figure 14.* Projections (7-day ahead) for the week starting 7^th^ June 2020 from individual models (Models 1, 2
...
```
*Figure 15.* Projections (7-day ahead) for the week starting 7^th^ June 2020 from individual models (Models 1, 2
...
7^th^ June 2020 from individual models (Models 1, 2
...
*Notes* 
Cameroon, Ecuador, Guatemala, Honduras and Sudan 
have been exlcuded from the analysis due to concerns about data 
reliability. The following corrections were applied to data downloaded
...
reported on Worldometers (https://www.worldometers.info/coronavirus/).
 ...
 - The latest data downloaded from
   ECDC did not contain data for 7^th^ June for Spain. 240 cases and 1
death were manually added to the downloaded file.

- The number of deaths in Brazil was manually corrected to 910 on
  6^th^ June and 542 on 7^th^ June.

- The number of deaths in Panama was manually corrected to 8 on
  3^rd^ June and 5 on 4^th^ June. 

- The number of deaths in Peru was manually corrected to 127 on
  3^rd^ June and 137 on 4^th^ June.
